...
class _AdminDashboardPageState extends State<AdminDashboardPage> {
  ...
  Future<void> _submitPromotionComposer() async {
    ...
    setState(() => _promotionComposerSaving = true);
    try {
      ...
      if (mounted) {
        setState(() => _promotionComposerSaving = false);
      }
    }
  }
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Switch(
                        ...
                        onChanged: (value) =>
                            setState(() => _promotionComposerActive = value),
                      ),
                    ],
                  ),
                  FilledButton.icon(
        ...
        _AdminTableCard<AdminPromotionRow>(
          ...
          controls: [
            _DropdownFilter(
              ...
              onChanged: (value) {
                setState(() => _promotionPlacementFilter = value);
            ...
            _DropdownFilter(
              ...
              onChanged: (value) {
                setState(() => _promotionTargetTypeFilter = value);
                unawaited(_loadPromotions(1));
              },
            ),
            _DropdownFilter(
              ...
              onChanged: (value) {
                setState(() => _promotionStatusFilter = value);
                unawaited(_loadPromotions(1));
              },
            ),
          ],
