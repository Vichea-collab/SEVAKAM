...
const PROVIDER_POST_SEEDS = [
  ...
  },
  {
    ...
    category: "Electrician",
    service: "Light / Fan Installation",
    area: "Phnom Penh",
    details: "Reliable installation of lights and fans. Safety first approach.",
    availableNow: true,
    createdHoursAgo: 5,
  },
  {
  ...
  },
  {
    ...
    area: "Phnom Penh",
    details: "Expert furniture repair and shelf installation services.",
    availableNow: true,
    createdHoursAgo: 6,
  },
];
  ...
  ORDER_REVIEW_SEEDS.forEach((seed) => {
    ...
    batch.set(
      ref,
      {
        ...
        providerImagePath: createAvatarUrl(provider.name),
        providerType: provider.providerType,
        providerCompanyName: provider.providerType === "company" ? provider.companyName : "",
        providerMaxWorkers: provider.providerType === "company" ? provider.maxWorkers : 1,
